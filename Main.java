...
public class Main {
    ...
    public static final int maxpar = 16;
    // Максимальное допустимое количество голосов
    public static final int maxgol = 100;
    ...
    public static void main(String[] args) {
        ...
        } while (n > maxgol);  // Повторяем, пока не введено корректное количество сообщений
